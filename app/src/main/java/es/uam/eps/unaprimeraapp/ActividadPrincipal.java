...
public class ActividadPrincipal extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        Button botoncoloreado = (Button) findViewById(R.id.button1);
        int colorblanco = getResources().getColor(R.color.blancoOpaco);
        botoncoloreado.setBackgroundColor(colorblanco);
